...
// Array of cybersecurity tools
    char* cybersecuritytool[] = {
        ...
        "gather then add all the code bases from all thee 'cybersecuritytool', 'billionaires', 'Companies' and 'areasOfWork' into one functioning app called 'Sapphire'.",
        "this is the sapphire app",
